<?php
    ...
    if(isset($_POST['tombol_tambah'])){
        ...
        $adddata = $kriteria->add_data($kd_kriteria, $nm_kriteria, $bobot);
        if($adddata){ ?>
                                                            ...
                                                            <div class="col-sm-12">
                                                              <form method="post">
                                                                  <div class="form-group row">
                                                                      ...
                                                                      <div class="col-sm-2">
                                                                          <input type="text" class="form-control" name="kd_kriteria" value="<?php echo $kriteria->createCode(); ?>" readonly>
                                                                      </div>
                                                                  </div>
                                                                  <div class="form-group row">
